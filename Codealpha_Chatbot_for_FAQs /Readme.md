...
📊 How It Works
Load FAQ dataset (faqs.csv)
Preprocess all questions using NLP techniques
Convert text into TF-IDF vectors
Take user input and preprocess it the same way
Compute similarity between input and dataset questions
